/*******************************************************************************
 * dgvoice.go
 * This is a modified version of https://github.com/bwmarrin/dgvoice to support start time of the audio file
 *
...
func PlayAudioFile(v *discordgo.VoiceConnection, filename string, startTime string, stop <-chan bool) {

	// Create a shell command "object" to run.
	run := exec.Command("ffmpeg", "-ss", startTime, "-i", filename, "-f", "s16le", "-ar", strconv.Itoa(frameRate), "-ac", strconv.Itoa(channels), "pipe:1")
